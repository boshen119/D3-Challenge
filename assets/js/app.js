...
// xText selects the group without excess code
...
// Create a function to chart vizualize it
...
function visualize(data){
   ...
   var toolTip = d3
    ...
    // First grab the min and max values of x and y responsiveness
    xMinMax() 
    yMinMax();
    ...
    theCircles 
        ...
        .attr("dx", function(d){
            return xScale(d[curX]) - (circRadius / 6.5)
        })
        .attr("dy", function(d){
...
//             return d.abbr
//         }).attr("dx", function(d){
//             return xScale(d[currentX]) - (circRadius / 1.5)
//         })
//         .attr("dy", function(d){
